...
class NotificationService {
  ...
  // 푸시 알림 생성
  Future<void> showNotification(List<dynamic> noticeList) async {
    String title;
    String content;
    Int64List pattern;
    if (noticeList[0] == "emergency") {
      title = '심박 이상 감지';
      content = '기기 사용자의 심박에 이상이 감지되었습니다.\n현재 심박 : ${noticeList[1]}bpm';
      pattern = Int64List(2000);
    } else {
      title = '실시간 정보';
      content = '걸음수 : ${noticeList[2]}걸음   심박수 : ${noticeList[1]}bpm';
      pattern = Int64List(0);
    }
    // 푸시 알림의 ID
    ...
    final AndroidNotificationDetails androidNotificationDetails =
      ...
      vibrationPattern: pattern, // 진동을 끄려면 빈 리스트
    );
